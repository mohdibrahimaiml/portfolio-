...
// Navbar background change on scroll - Updated for black and white theme
function initNavbarScroll() {
    ...
    window.addEventListener('scroll', function() {
        ...
        const isDarkTheme = document.documentElement.getAttribute('data-color-scheme') === 'dark' || 
                           (prefersDark && !document.documentElement.getAttribute('data-color-scheme'));
...
function initAccessibilityFeatures() {
    ...
    focusableElements.forEach(element => {
        element.addEventListener('focus', function() {
            ...
            this.style.outline = isDarkTheme ? '2px solid var(--color-white)' : '2px solid var(--color-black)';
...
// Theme detection and handling - Updated for black/white navigation
